# Generated by Django 4.2 on 2024-10-09 16:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('table_type', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='table_type', to='metadata.tabletype')),
                ('tenant', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='tenant', to='metadata.tenant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('table_filter', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='table_filter', to='metadata.tablefilter')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('field', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='tenant_table_field', to='metadata.tablefield')),
                ('field_order', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='field_order', to='metadata.fieldorder')),
                ('tenant_table', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='metadata.tenanttable')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='data_type', to='metadata.datatype'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='table_filter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='items', to='metadata.tablefilter'),
        ),
        migrations.AddIndex(
            model_name='tablefieldlocalization',
